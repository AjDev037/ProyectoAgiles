...
object DAOMaterias {
    ...
    private fun crearMaestrosScript(){
        ...
        var materia1 = Materia("00000001","Materia1","1824", null, DAOAlumnos.getAlumnos(), DAOMaestro.getMaestro("000001111"), null, DAOHorarios.getHorario(0) )
        var materia2 = Materia("00000002","Materia2","1825", null, DAOAlumnos.getAlumnos(), DAOMaestro.getMaestro("000002222"), null, DAOHorarios.getHorario(1) )
